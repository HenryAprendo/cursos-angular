...
describe('ProductsComponent', () => {
  ...
  describe('Tests for getAllProducts', () => {
    ...
    it('should return change the status "loading" => "success"', fakeAsync(() => {
      // Arrange
      const productsMock = generateManyProducts(10);
      productService.getAll.and.returnValue(asyncData<Product[]>(productsMock)); //puedo definir el tipo de la data con generics o sin ellos.
  ...
  describe('test for callPromise', () => {
    ...
    it('should show "my mock string" in <p> when btn was clicked', fakeAsync(() => {
      ...
      valueService.getPromiseValue.and.returnValue(mockPromise<string>(mockMsg));
      ...
      tick();
      fixture.detectChanges();
      // const rtaText = fixture.debugElement.query(By.css('p.rta'));
        const rtaText = getText(fixture,'rta');
      // Assert
      expect(component.rta).toEqual(mockMsg);
      expect(valueService.getPromiseValue).toHaveBeenCalled();
      expect(rtaText).toEqual(mockMsg);
    }));
  })
